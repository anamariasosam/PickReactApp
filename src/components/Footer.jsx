  ...
  <footer className="pa4 pa5-l black-70 bt b--black-10">
    ...
    <div className="dt dt--fixed w-100" >
      ...
      <div className="db dtc-ns black-70 tc tr-ns v-mid">
        <a className="link dim gray dib h2 w2 br-100 mr3 pa2 bg-near-white ba b--black-10" href="https://twitter.com/anamariasosam" target="_blank" rel="noopener noreferrer">
          <svg data-icon="twitter" viewBox="0 0 32 32">
          <title>twitter icon</title>
          <path d="M2 4 C6 8 10 12 15 11 A6 6 0 0 1 22 4 A6 6 0 0 1 26 6 A8 8 0 0 0 31 4 A8 8 0 0 1 28 8 A8 8 0 0 0 32 7 A8 8 0 0 1 28 11 A18 18 0 0 1 10 30 A18 18 0 0 1 0 27 A12 12 0 0 0 8 24 A8 8 0 0 1 3 20 A8 8 0 0 0 6 19.5 A8 8 0 0 1 0 12 A8 8 0 0 0 3 13 A8 8 0 0 1 2 4"></path>
          </svg>
        </a>
        <a className="link dim gray dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" href="https://github.com/anamariasosam/pick_react_app" target="_blank" rel="noopener noreferrer">
